...
function App() {
	...
	return (
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/7/70/Golf.png" alt="golf ball icon" style={{ width: 36, height: 36, marginRight: 12, background: '#fff', borderRadius: '50%', padding: 4 }} />
